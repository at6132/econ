...
RECIPES: Final[Mapping[str, Recipe]] = {
    ...
    # ─────────────── Technology tree (research_lab unlocks; grid-aware) ───────────────
    "electric_pump": Recipe(
        recipe_id="electric_pump",
        display_name="Electric pump unit (motorized machine shop)",
        inputs={
            MaterialId("cast_iron"): 2,
            MaterialId("copper_wire"): 3,
            MaterialId("steel_ingot"): 1,
            MaterialId("electricity"): 3,
        },
        outputs={MaterialId("pump_unit"): 2},
        duration_ticks=4 * _TICKS_PER_GAME_HOUR,
        labor_cents=28_00,
        requires_building_id="machine_shop",
        requires_discovery=True,
    ),
    "electric_drill": Recipe(
        recipe_id="electric_drill",
        display_name="Electric drill cycle (strip mine — high grid draw)",
        inputs={MaterialId("electricity"): 5},
        outputs={MaterialId("iron_ore"): 4},
        duration_ticks=legacy_scaled(2),
        labor_cents=32_00,
        requires_building_id="strip_mine",
        requires_subsurface=(("iron_ore_grade", 0.3),),
    ...
    "telegraph_line": Recipe(
        recipe_id="telegraph_line",
        display_name="Telegraph line kit (machine shop)",
        inputs={
            MaterialId("copper_wire"): 3,
            MaterialId("lumber"): 2,
            MaterialId("electricity"): 2,
        },
        outputs={MaterialId("telegraph_relay"): 2},
        duration_ticks=3 * _TICKS_PER_GAME_HOUR,
        labor_cents=18_00,
        requires_building_id="machine_shop",
        requires_discovery=True,
    ),
    "turbine_generator": Recipe(
        recipe_id="turbine_generator",
        display_name="Steam turbine generator (coal → grid export)",
        inputs={MaterialId("coal"): 2},
        outputs={MaterialId("electricity"): 5},
        duration_ticks=legacy_scaled(3),
        labor_cents=4_00,
        requires_building_id="power_shed",
        requires_discovery=True,
    ...
    "dye_synthesis": Recipe(
        recipe_id="dye_synthesis",
        display_name="Synthetic dye batch (chemical works)",
        inputs={
            MaterialId("sulfuric_acid"): 1,
            MaterialId("coal"): 1,
            MaterialId("electricity"): 2,
        },
        outputs={MaterialId("synthetic_dye"): 2},
        duration_ticks=5 * _TICKS_PER_GAME_HOUR,
        labor_cents=20_00,
        requires_building_id="chemical_works",
        requires_discovery=True,
    ...
    "blast_mining": Recipe(
        recipe_id="blast_mining",
        display_name="Blast mining (gunpowder + power → coal)",
        inputs={
            MaterialId("gunpowder"): 1,
            MaterialId("electricity"): 3,
        },
        outputs={MaterialId("coal"): 4},
        duration_ticks=legacy_scaled(2),
        labor_cents=28_00,
        requires_building_id="strip_mine",
        requires_subsurface=(("coal_grade", 0.3),),
    ...
    "fertilizer_plant": Recipe(
        recipe_id="fertilizer_plant",
        display_name="Fertilized grain row (phosphate meal + power)",
        inputs={
            MaterialId("phosphate_meal"): 2,
            MaterialId("electricity"): 2,
        },
        outputs={MaterialId("grain"): 5},
        duration_ticks=legacy_scaled(4),
        labor_cents=22_00,
        requires_building_id="grain_row",
        requires_discovery=True,
    ),
    "radio_broadcast": Recipe(
        recipe_id="radio_broadcast",
        display_name="Vacuum tube batch (machine shop)",
        inputs={
            MaterialId("copper_wire"): 2,
            MaterialId("glass"): 2,
            MaterialId("electricity"): 3,
        },
        outputs={MaterialId("vacuum_tube"): 3},
        duration_ticks=6 * _TICKS_PER_GAME_HOUR,
        labor_cents=24_00,
        requires_building_id="machine_shop",
        requires_discovery=True,
    ),
    "semiconductor_fab": Recipe(
        recipe_id="semiconductor_fab",
        display_name="Semiconductor fab run (machine shop)",
        inputs={
            MaterialId("vacuum_tube"): 2,
            MaterialId("fused_silica"): 1,
            MaterialId("electricity"): 4,
        },
        outputs={MaterialId("transistor"): 2},
        duration_ticks=8 * _TICKS_PER_GAME_HOUR,
        labor_cents=35_00,
        requires_building_id="machine_shop",
        requires_discovery=True,
    ),
    "automated_factory": Recipe(
        recipe_id="automated_factory",
        display_name="Automated assembly (machine shop)",
        inputs={
            MaterialId("transistor"): 2,
            MaterialId("gear_set"): 2,
            MaterialId("pump_unit"): 1,
            MaterialId("electricity"): 5,
        },
        outputs={MaterialId("control_module"): 1},
        duration_ticks=10 * _TICKS_PER_GAME_HOUR,
        labor_cents=45_00,
        requires_building_id="machine_shop",
        requires_discovery=True,
    ),
    "composite_build": Recipe(
        recipe_id="composite_build",
        display_name="Carbon fiber layup (chemical works)",
        inputs={
            MaterialId("lumber"): 4,
            MaterialId("coal"): 2,
            MaterialId("electricity"): 3,
        },
        outputs={MaterialId("carbon_fiber"): 2},
        duration_ticks=6 * _TICKS_PER_GAME_HOUR,
        labor_cents=30_00,
        requires_building_id="chemical_works",
        requires_discovery=True,
    ),
    "nano_fabrication": Recipe(
        recipe_id="nano_fabrication",
        display_name="Nanofiber fabrication (chemical works)",
        inputs={
            MaterialId("carbon_fiber"): 2,
            MaterialId("electricity"): 6,
        },
        outputs={MaterialId("nanofiber"): 1},
        duration_ticks=12 * _TICKS_PER_GAME_HOUR,
        labor_cents=55_00,
        requires_building_id="chemical_works",
        requires_discovery=True,
    ),
    "fusion_reactor": Recipe(
        recipe_id="fusion_reactor",
        display_name="Fusion reactor pulse (power shed — grid export)",
        inputs={
            MaterialId("steel_ingot"): 2,
            MaterialId("rare_earth_ore"): 1,
            MaterialId("electricity"): 2,
        },
        outputs={MaterialId("electricity"): 10},
        duration_ticks=legacy_scaled(6),
        labor_cents=60_00,
        requires_building_id="power_shed",
        requires_discovery=True,
    ),
    "assembler": Recipe(
        recipe_id="assembler",
        display_name="Molecular assembler run (machine shop)",
        inputs={
            MaterialId("nanofiber"): 1,
            MaterialId("control_module"): 1,
            MaterialId("electricity"): 8,
        },
        outputs={
            MaterialId("pump_unit"): 2,
            MaterialId("gear_set"): 2,
            MaterialId("drill_bit"): 2,
        },
